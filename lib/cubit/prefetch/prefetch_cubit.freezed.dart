...
abstract class _Initial implements PrefetchState {
...
class _$_FetchInProgress implements _FetchInProgress {
  ...
  @override
  String toString() {
    return 'PrefetchState.fetchInProgress()';
  }
...
abstract class _FetchInProgress implements PrefetchState {
...
class _$_FetchSuccess implements _FetchSuccess {
  ...
  @override
  String toString() {
    return 'PrefetchState.fetchSuccess()';
  }
...
abstract class _FetchSuccess implements PrefetchState {
...
class _$_FetchFailure implements _FetchFailure {
  ...
  @override
  String toString() {
    return 'PrefetchState.fetchFailure()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _FetchFailure);
  }
...
abstract class _FetchFailure implements PrefetchState {
