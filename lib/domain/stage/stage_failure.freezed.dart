...
/// @nodoc
class _$StageFailureTearOff {
  const _$StageFailureTearOff();
...
/// @nodoc
const $StageFailure = _$StageFailureTearOff();

/// @nodoc
mixin _$StageFailure {
  @optionalTypeArgs
...
/// @nodoc
abstract class $StageFailureCopyWith<$Res> {
  factory $StageFailureCopyWith(
          StageFailure value, $Res Function(StageFailure) then) =
      _$StageFailureCopyWithImpl<$Res>;
}

/// @nodoc
class _$StageFailureCopyWithImpl<$Res> implements $StageFailureCopyWith<$Res> {
  _$StageFailureCopyWithImpl(this._value, this._then);

  final StageFailure _value;
  // ignore: unused_field
  final $Res Function(StageFailure) _then;
}
...
class __$RemoteServerErrorCopyWithImpl<$Res>
    extends _$StageFailureCopyWithImpl<$Res>
...
class _$_RemoteServerError implements _RemoteServerError {
  ...
  @override
  String toString() {
    return 'StageFailure.remoteServerError(code: $code, description: $description)';
  }
...
abstract class _RemoteServerError implements StageFailure {
...
class _$_UnexpectedError implements _UnexpectedError {
  ...
  @override
  String toString() {
    return 'StageFailure.unexpectedError()';
  }
...
abstract class _UnexpectedError implements StageFailure {
